-- =====================================================================
-- Pilgrimage / Yatra — Supabase bootstrap (SAFE, re-runnable)
-- File: supabase/pilgrimage_bootstrap_safe.sql
-- NOTE: This version skips destructive drops. It is safe to re-run.
-- =====================================================================
